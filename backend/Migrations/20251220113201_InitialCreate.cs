        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertisementId = table.Column<int>(type: "integer", nullable: false),
                    IsSupportChat = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() AT TIME ZONE 'UTC'"),
                    IsEdited = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementCategories_AdvertisementId_CategoryId",
                table: "AdvertisementCategories",
                columns: new[] { "AdvertisementId", "CategoryId" },
                unique: true);
